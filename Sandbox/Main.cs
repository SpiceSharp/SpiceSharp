...
namespace Sandbox
{
    public partial class Main : Form
    {
        ...
        public Main()
        {
            ...
            // Run test
            int index = 0;
            dc.OnExportSimulationData += (object sender, SimulationDataEventArgs data) =>
            {
                double v = dc.Sweeps[0].CurrentValue;
                plotInput.Points.AddXY(v, exports[0](data.Circuit.State));
                plotOutput.Points.AddXY(v, references[0][index++]);
            };
            dc.Run(ckt);
        }
