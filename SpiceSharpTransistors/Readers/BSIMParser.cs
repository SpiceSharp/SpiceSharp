...
namespace SpiceSharp.Components
{
    ...
    public static class BSIMParser
    {
        ...
        public static Dictionary<Type, Func<CircuitIdentifier, CircuitObject, Component>> Mosfets { get; } = new Dictionary<Type, Func<CircuitIdentifier, CircuitObject, Component>>()
        {
            ...
            { typeof(BSIM2Model), (CircuitIdentifier name, CircuitObject model) =>
            {
                BSIM2 m = new BSIM2(name);
                m.SetModel((BSIM2Model)model);
                return m;
            } },
            { typeof(BSIM3v24Model), (CircuitIdentifier name, CircuitObject model) =>
            {
                BSIM3v24 m = new BSIM3v24(name);
                m.SetModel((BSIM3v24Model)model);
                return m;
            } },
            { typeof(BSIM3v30Model), (CircuitIdentifier name, CircuitObject model) =>
            {
                BSIM3v30 m = new BSIM3v30(name);
                m.SetModel((BSIM3v30Model)model);
                return m;
            } },
            { typeof(BSIM4v80Model), (CircuitIdentifier name, CircuitObject model) =>
            {
        ...
        /// </summary>
        public static Dictionary<int, Func<CircuitIdentifier, string, string, CircuitObject>> Levels { get; } = new Dictionary<int, Func<CircuitIdentifier, string, string, CircuitObject>>()
        {
        ...
        public static void AddMosfetModelGenerators(Dictionary<int, Func<CircuitIdentifier, string, string, CircuitObject>> levels)
        {
        ...
        /// <returns></returns>
        public static CircuitObject GenerateBSIM1Model(CircuitIdentifier name, string type, string version)
        {
        ...
        /// <param name="version">Version</param>
        /// <returns></returns>
        public static CircuitObject GenerateBSIM2Model(CircuitIdentifier name, string type, string version)
        {
        ...
        /// <returns></returns>
        public static CircuitObject GenerateBSIM3Model(CircuitIdentifier name, string type, string version)
        {
            double v = 3.3;
            switch (version)
            {
        ...
        /// <param name="version">Version</param>
        /// <returns></returns>
        public static CircuitObject GenerateBSIM4Model(CircuitIdentifier name, string type, string version)
        {
            double v = 4.8;
            switch (version)
            {
