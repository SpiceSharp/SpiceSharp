...
{
    public class BSIM3v21Model : CircuitModel<BSIM3v21Model>
    {
        /// <summary>
        /// Register our model parameters
        /// </summary>
        static BSIM3v21Model()
        {
            Register();
        }
        ...
        public string BSIM3version { get; } = "3.2.1";
        ...
        public double BSIM3modName { get; private set; }
        ...
        public BSIM3v21Model(string name) : base(name)
        {
        }
