...
{
    public class BSIM3v23Model : CircuitModel<BSIM3v23Model>
    {
        /// <summary>
        /// Register our model parameters
        /// </summary>
        static BSIM3v23Model()
        {
            Register();
        }
        ...
        public string BSIM3version { get; } = "3.2.3";
        ...
        public BSIM3v23Model(string name) : base(name)
        {
        }
