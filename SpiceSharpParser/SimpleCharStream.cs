...
{
    /// <summary>
    /// A simple character stream used for parsing
    ...
    public class SimpleCharStream
    {
        ...
        {
            if (inputStream != null)
                throw new System.SystemException("\n   ERROR: Second call to the constructor of a SimpleCharStream.  You must\n" +
                "       either use ReInit() or set the CSharpCC option to false\n" +
