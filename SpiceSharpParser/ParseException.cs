...
namespace SpiceSharp.Parser
{
    ...
    /// This class was generated by CSharpCC (a port of JavaCC to C#). Refer to spicelang.cc for the syntax.
    /// </summary>
    [Serializable]
    public class ParseException : Exception
    {
        ...
        /// <summary>
        /// Constructor for parse exceptions at a specific token
        /// </summary>
        /// <param name="token">The token</param>
        /// <param name="message">The error message</param>
        /// <param name="before">Defaults to true. If false, then the end of the token is considered to be the point of the error</param>
