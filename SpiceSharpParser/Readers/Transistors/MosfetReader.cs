...
namespace SpiceSharp.Parser.Readers
{
    ...
    public class MosfetReader : ComponentReader
    {
        ...
        /// </summary>
        public Dictionary<Type, Func<CircuitIdentifier, CircuitObject, CircuitComponent>> Mosfets { get; } = new Dictionary<Type, Func<CircuitIdentifier, CircuitObject, CircuitComponent>>();
        ...
        {
            // MOS1
            Mosfets.Add(typeof(MOS1Model), (CircuitIdentifier name, CircuitObject model) =>
            {
                var m = new MOS1(name);
            ...
            // MOS2
            Mosfets.Add(typeof(MOS2Model), (CircuitIdentifier name, CircuitObject model) =>
            {
                var m = new MOS2(name);
            ...
            // MOS3
            Mosfets.Add(typeof(MOS3Model), (CircuitIdentifier name, CircuitObject model) =>
            {
                var m = new MOS3(name);
        ...
        protected override CircuitObject Generate(string type, CircuitIdentifier name, List<Token> parameters, Netlist netlist)
        {
            ...
            CircuitObject model = netlist.Path.FindModel<CircuitObject>(netlist.Circuit.Objects, new CircuitIdentifier(parameters[4].image));
