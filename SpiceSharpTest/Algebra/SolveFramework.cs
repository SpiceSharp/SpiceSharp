...
public class SolveFramework
{
    ...
    protected static void ReadMatrix(ISparseSolver<double> solver, string filename)
    {
    ...
    /// <param name="solver">The solver.</param>
    /// <param name="filename">The filename.</param>
    protected static void ReadRhs(ISparseSolver<double> solver, string filename)
    {
        using var sr = new StreamReader(filename);
    ...
    protected static SparseRealSolver ReadSpice3f5File(string matFilename, string vecFilename)
    {
        ...
        LoadSpice3f5File(solver, matFilename, vecFilename);
        return solver;
    }

    /// <summary>
    /// Loads a matrix file generated by Spice 3f5 into an existing solver.
    /// </summary>
    /// <param name="solver">The solver.</param>
    /// <param name="matFilename">The matrix filename.</param>
    /// <param name="vecFilename">The vector filename.</param>
    protected static void LoadSpice3f5File(ISparseSolver<double> solver, string matFilename, string vecFilename)
    {
        // Read the spice file
        string line;
