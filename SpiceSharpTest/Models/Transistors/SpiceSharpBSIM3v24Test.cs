...
{
    [TestClass]
    public class SpiceSharpBSIM3v24Test
    {
        /// <summary>
        ...
        /// [ids_VDS=3.3&VGS=3.3]
        /// 
        /// So there should be 11*11 = 121 lines in the file
        /// 
        ...
        /// Test model NMOS
        /// </summary>
        private static BSIM3v24Model TestModelPMOS
        {
            get
            {
                BSIM3v24Model model = new BSIM3v24Model("TestModelPMOS");
                model.SetPMOS(true);
        ...
        [TestMethod]
        public void TestBSIM3v24_NMOS_DC()
        {
        ...
        public void TestBSIM3v24_PMOS_DC()
        {
            ...
            // Generate the simulation
            DC dc = new DC("TestBSIM3v24_PMOS_DC");
            dc.Sweeps.Add(new DC.Sweep("V1", 0, 3.3, 0.3));
            dc.Sweeps.Add(new DC.Sweep("V2", 0, 3.3, 0.3));
            int index = 0;
            dc.OnExportSimulationData += (object sender, SimulationData data) =>
