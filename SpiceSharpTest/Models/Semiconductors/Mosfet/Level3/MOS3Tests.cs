    ...
    public class MOS3Tests : Framework
    {
        ...
        public void When_SimpleDC_Expect_Spice3f5Reference()
        {
            ...
            var dc = new DC("dc", new[] {
                new SourceSweep("V2", new LinearSweep(0, 1.8, 0.3)),
                new SourceSweep("V1", new LinearSweep(0, 1.8, 0.3))
            });
        ...
        public void When_SwitchTransient_Expect_Spice3f5Reference()
        {
            ...
            // Create exports
            IExport<double>[] exports = { new GenericExport<double>(tran, () => tran.State.Time), new RealVoltageExport(tran, "out") };
