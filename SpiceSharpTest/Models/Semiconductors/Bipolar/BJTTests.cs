    ...
    public class BJTTests : Framework
    {
        ...
        public void When_BJTTransient_Expect_Spice3f5Reference()
        {
            ...
            references[0] = new[]
            {
                ...
                1.137869825844853e+00, 9.015485310391745e-01, 5.114374218051296e-01, 4.317883404067391e-01,
                2.896439882102821e-01, 7.880030660984598e-02, 1.607176535743225e-02, 1.218672633846727e-02,
                8.940034780949789e-03, 8.466396310908189e-03, 7.810926065821902e-03, 7.931482402276063e-03,
                7.741615150852236e-03, 7.888344042805985e-03, 7.757571072370122e-03, 7.870701571456922e-03,
                7.786125081560294e-03, 7.700257099983869e-03, 7.468686766496058e-03, 7.081173512162859e-03,
                6.644980558710726e-03, 6.001915555808019e-03, 6.334377328642827e-03, 7.494774724254995e-03,
                1.052198511477223e-02, 2.183511028512625e-02, 5.173267278225494e-02, 5.736729685240333e-02
            };
            ...
            tran.ExportSimulationData += (sender, args) =>
            {
                ...
                // Problem exists between t = 1.6045070020821347E-06 and t = 1.7943825973471637E-06,
                //                                we would expect time   t = 1.7950215092131668E-06
                oldt = t;
            };
