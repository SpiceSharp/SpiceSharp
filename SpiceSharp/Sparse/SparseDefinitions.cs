...
namespace SpiceSharp.Sparse
{
    ...
    public static class SparseDefinitions
    {
        ...
        internal static void CMPLX_CONJ_ASSIGN(ref ElementValue to, ElementValue from)
        {
            to.Real = from.Real;
            to.Imag = -from.Imag;
        }
        internal static void CMPLX_NEGATE_ASSIGN(ref ElementValue to, ElementValue from)
        {
            to.Real = -from.Real;
            to.Imag = -from.Imag;
        }
        internal static void CMPLX_CONJ_NEGATE_ASSIGN(ref ElementValue to, ElementValue from)
        {
            to.Real = -from.Real;
            to.Imag = from.Imag;
        }
        internal static void CMPLX_CONJ(ref ElementValue a) => a.Imag = -a.Imag;
        internal static void CMPLX_NEGATE(ref ElementValue a)
        {
            a.Real = -a.Real;
            a.Imag = -a.Imag;
        }
        ...
        internal static void CMPLX_2_NORM(ElementValue a) => Math.Sqrt(a.Real * a.Real + a.Imag * a.Imag);

        // Macro function that performs complex addition. 
        internal static void CMPLX_ADD(ref ElementValue to, ElementValue from_a, ElementValue from_b)
        {
        ...
        internal static void CMPLX_SUBT(ref ElementValue to, ElementValue from_a, ElementValue from_b)
        {
            to.Real = from_a.Real - from_b.Real;
            to.Imag = from_a.Imag - from_b.Imag;
        }
        ...
        internal static void CMPLX_ADD_ASSIGN(ref ElementValue to, ElementValue from)
        {
            to.Real += from.Real;
            to.Imag += from.Imag;
        }
        ...
        // Macro function that is equivalent to -= operator for complex numbers. 
        internal static void CMPLX_SUBT_ASSIGN(ref ElementValue to, ElementValue from)
        {
            to.Real -= from.Real;
            to.Imag -= from.Imag;
        }
        ...
        internal static void SCLR_MULT(ref ElementValue to, double sclr, ElementValue cmplx)
        {
        ...
        internal static void SCLR_MULT_ASSIGN(ref ElementValue to, ElementValue sclr)
        {
            to.Real *= sclr;
            to.Imag *= sclr;
        }
        ...
        internal static void CMPLX_MULT(ref ElementValue to, ElementValue from_a, ElementValue from_b)
        {
            to.Real = from_a.Real * from_b.Real -
        ...
        internal static void CMPLX_MULT_ASSIGN(ref ElementValue to, ElementValue from)
        {
         ...
         * conjugated. */
        internal static void CMPLX_CONJ_MULT(ref ElementValue to, ElementValue from_a, ElementValue from_b)
        {
            to.Real = from_a.Real * from_b.Real +
                from_a.Imag * from_b.Imag;
            to.Imag = from_a.Real * from_b.Imag -
        ...
        internal static void CMPLX_MULT_ADD(ref ElementValue to, ElementValue mult_a, ElementValue mult_b, ElementValue add)
        {
        ...
        internal static void CMPLX_MULT_SUBT(ref ElementValue to, ElementValue mult_a, ElementValue mult_b, ElementValue subt)
        {
        ...
        // conjugate.
        internal static void CMPLX_CONJ_MULT_ADD(ref ElementValue to, ElementValue mult_a, ElementValue mult_b, ElementValue add)
        {
            to.Real = mult_a.Real * mult_b.Real +
                        mult_a.Imag * mult_b.Imag + add.Real;
            to.Imag = mult_a.Real * mult_b.Imag -
        ...
        internal static void CMPLX_MULT_ADD_ASSIGN(ref ElementValue to, ElementValue from_a, ElementValue from_b)
        {
            to.Real += from_a.Real * from_b.Real -
                         from_a.Imag * from_b.Imag;
            to.Imag += from_a.Real * from_b.Imag +
         ...
         * from another. */
        internal static void CMPLX_MULT_SUBT_ASSIGN(ref ElementValue to, ElementValue from_a, ElementValue from_b)
        {
            to.Real -= from_a.Real * from_b.Real -
                         from_a.Imag * from_b.Imag;
            to.Imag -= from_a.Real * from_b.Imag +
        ...
        // conjugate.
        internal static void CMPLX_CONJ_MULT_ADD_ASSIGN(ref ElementValue to, ElementValue from_a, ElementValue from_b)
        {
            to.Real += from_a.Real * from_b.Real +
                         from_a.Imag * from_b.Imag;
            to.Imag += from_a.Real * from_b.Imag -
         ...
         * conjugate. */
        internal static void CMPLX_CONJ_MULT_SUBT_ASSIGN(ref ElementValue to, ElementValue from_a, ElementValue from_b)
        {
            to.Real -= from_a.Real * from_b.Real +
                         from_a.Imag * from_b.Imag;
            to.Imag -= from_a.Real * from_b.Imag -
        ...
        internal static void CMPLX_DIV(ref ElementValue to, ElementValue num, ElementValue den)
        {
            double r_, s_;
        ...
        internal static void CMPLX_DIV_ASSIGN(ref ElementValue num, ElementValue den)
        {
            double r_, s_, t_;
            if ((den.Real >= den.Imag && den.Real > -den.Imag) ||
                (den.Real < den.Imag && den.Real <= -den.Imag))
        ...
        internal static void CMPLX_RECIPROCAL(ref ElementValue to, ElementValue den)
        {
            double r_;
            if ((den.Real >= den.Imag && den.Real > -den.Imag) ||
                (den.Real < den.Imag && den.Real <= -den.Imag))
        ...
        internal static void SWAP(ref ElementValue a, ref ElementValue b)
        {
            ElementValue swapx = a;
            a = b;
            b = swapx;
        }
        internal static void SWAP(ref MatrixElement a, ref MatrixElement b)
        {
