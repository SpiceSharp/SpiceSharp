...
namespace SpiceSharp.Components
{
    public partial class LosslessTransmissionLine
    {
        ...
        /// <seealso cref="LosslessTransmissionLineParameters"/>
        protected class BiasingBehavior : Behavior, 
            IBiasingBehavior,
            IParameterized<LosslessTransmissionLineParameters>
        {
            ...
            /// <inheritdoc/>
            public LosslessTransmissionLineParameters Parameters { get; }
                ...
                : base(name)
            {
                ...
                // Get parameters
                Parameters = context.GetParameterSet<LosslessTransmissionLineParameters>();
