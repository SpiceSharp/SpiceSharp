...
namespace SpiceSharp.Components.Diodes
{
        ...
        INoiseBehavior
    {
        ...
        /// <summary>
        /// Gets the diode noise generators.
        /// </summary>
        /// <value>
        /// The diode noise generators.
        /// </value>
        ...
        void INoiseBehavior.Noise()
        {
            ...
            DiodeNoise.Generators[_flickerNoise].SetCoefficients(ModelParameters.FlickerNoiseCoefficient * m / n * Math.Exp(ModelParameters.FlickerNoiseExponent 
