...
namespace SpiceSharp.Components.MosfetBehaviors.Level3
{
    ...
    public abstract class DynamicParameterBehavior : BiasingBehavior
    {
        ...
        protected void CalculateBaseCapacitances()
        {
            ...
            F2D = CapBd * (1 - ModelParameters.ForwardCapDepletionCoefficient * (1 + ModelParameters.BulkJunctionBotGradingCoefficient)) *
                  sarg / arg + CapBdSidewall * (1 - ModelParameters.ForwardCapDepletionCoefficient * (1 + ModelParameters.BulkJunctionSideGradingCoefficient)) * sargsw /
                  arg;
            F3D = CapBd * ModelParameters.BulkJunctionBotGradingCoefficient * sarg / arg / ModelParameters.BulkJunctionPotential + CapBd *
                  ModelParameters.BulkJunctionSideGradingCoefficient * sargsw / arg / ModelParameters.BulkJunctionPotential;
            F4D = CapBd * ModelParameters.BulkJunctionPotential * (1 - arg * sarg) / (1 - ModelParameters.BulkJunctionBotGradingCoefficient) +
                  CapBdSidewall * ModelParameters.BulkJunctionPotential * (1 - arg * sargsw) / (1 - ModelParameters.BulkJunctionSideGradingCoefficient) -
            ...
            F2S = CapBs * (1 - ModelParameters.ForwardCapDepletionCoefficient * (1 + ModelParameters.BulkJunctionBotGradingCoefficient)) *
                  sarg / arg + CapBsSidewall * (1 - ModelParameters.ForwardCapDepletionCoefficient * (1 + ModelParameters.BulkJunctionSideGradingCoefficient)) * sargsw / arg;
            F3S = CapBs * ModelParameters.BulkJunctionBotGradingCoefficient * sarg / arg / ModelParameters.BulkJunctionPotential +
                  CapBsSidewall * ModelParameters.BulkJunctionSideGradingCoefficient * sargsw / arg / ModelParameters.BulkJunctionPotential;
            F4S = CapBs * ModelParameters.BulkJunctionPotential * (1 - arg * sarg) / (1 - ModelParameters.BulkJunctionBotGradingCoefficient) +
                  CapBsSidewall * ModelParameters.BulkJunctionPotential * (1 - arg * sargsw) / (1 - ModelParameters.BulkJunctionSideGradingCoefficient) -
