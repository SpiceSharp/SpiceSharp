...
namespace SpiceSharp.Components.ComponentBehaviours
{
    ...
    /// </summary>
    public class MOS3AcBehaviour : CircuitObjectBehaviourAcLoad
    {
        /// <summary>
        /// Execute behaviour
        /// </summary>
        ...
        public override void Execute(Circuit ckt)
        {
            ...
            cstate.Matrix[mos3.MOS3dNodePrime, mos3.MOS3dNodePrime] += new Complex(mos3.MOS3drainConductance + mos3.MOS3gds + mos3.MOS3gbd + xrev * (mos3.MOS3gm +
                mos3.MOS3gmbs), xgd + xbd);
            cstate.Matrix[mos3.MOS3sNodePrime, mos3.MOS3sNodePrime] += new Complex(mos3.MOS3sourceConductance + mos3.MOS3gds + mos3.MOS3gbs + xnrm * (mos3.MOS3gm +
                mos3.MOS3gmbs), xgs + xbs);
