            ...
            if (_mbp.Gamma > 0.0 || _mbp.SubstrateDoping > 0.0)
            {
                ...
                */
                ...
                if (_mbp.JunctionDepth > 0)
                {
                    ...
                    var dasdb2 = -_modeltemp.Xd *
                                 (d2Sdb2 + dsrgdb * dsrgdb * _modeltemp.Xd / (_mbp.JunctionDepth * argxs)) /
                                 (effectiveLength *
                                  args);
                    var daddb2 = -_modeltemp.Xd *
                                 (d2Bdb2 + dbrgdb * dbrgdb * _modeltemp.Xd / (_mbp.JunctionDepth * argxd)) /
                                 (effectiveLength *
                                  argd);
