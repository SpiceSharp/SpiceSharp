...
namespace SpiceSharp.Components.MosfetBehaviors.Level2
{
    ...
    public class NoiseBehavior : Behaviors.NoiseBehavior, IConnectedBehavior
    {
        ...
        public override void Noise(Noise simulation)
        {
            ...
            Mosfet2Noise.Generators[FlickerNoise].SetCoefficients(mnp.FlickerNoiseCoefficient * Math.Exp(mnp.FlickerNoiseExponent * Math.Log(Math.Max(Math.Abs(load.Cd), 1e-38))) 
