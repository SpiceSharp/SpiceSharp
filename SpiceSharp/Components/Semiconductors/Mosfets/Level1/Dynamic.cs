...
{
    /// <summary>
    /// This class allows calculation of dynamic (time-dependent) parameters for a <see cref="Mosfet1" />.
    /// </summary>
    ...
    public abstract class Dynamic : Biasing
    {
        ...
        protected Dynamic(string name, ComponentBindingContext context) 
            : base(name, context)
        {
        }
