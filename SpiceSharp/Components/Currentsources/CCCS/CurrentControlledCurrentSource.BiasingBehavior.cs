...
{
    public partial class CurrentControlledCurrentSource
    {
        /// <summary>
            ...
            IParameterized<CurrentControlledCurrentSourceParameters>
        {
            ...
            /// <inheritdoc/>
            public CurrentControlledCurrentSourceParameters Parameters { get; }
            ...
            public BiasingBehavior(string name, ICurrentControlledBindingContext context) : base(name)
            {
                ...
                Parameters = context.GetParameterSet<CurrentControlledCurrentSourceParameters>();
