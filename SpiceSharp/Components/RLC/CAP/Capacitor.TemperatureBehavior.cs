...
namespace SpiceSharp.Components
{
    public partial class Capacitor
    {
        ...
        protected class TemperatureBehavior : Behavior, 
            ITemperatureBehavior,
            IParameterized<CapacitorParameters>
        {
            private readonly CapacitorModelParameters _mbp = null;
            private readonly ITemperatureSimulationState _temperature;

            /// <inheritdoc/>
            public CapacitorParameters Parameters { get; }
            ...
            public TemperatureBehavior(string name, IComponentBindingContext context) : base(name)
            {
                ...
                // Get parameters
                Parameters = context.GetParameterSet<CapacitorParameters>();
                if (context.ModelBehaviors != null)
                    _mbp = context.ModelBehaviors.GetParameterSet<CapacitorModelParameters>();
