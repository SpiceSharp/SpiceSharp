...
namespace SpiceSharp.Components
{
    public partial class MutualInductance
    {
            ...
            IParameterized<MutualInductanceParameters>
        {
            ...
            /// </summary>
            public MutualInductanceParameters Parameters { get; }
            ...
            public TemperatureBehavior(string name, BindingContext context) : base(name)
            {
                context.ThrowIfNull(nameof(context));

                Parameters = context.GetParameterSet<MutualInductanceParameters>();
