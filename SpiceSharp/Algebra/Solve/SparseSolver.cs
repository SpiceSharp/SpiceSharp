...
namespace SpiceSharp.Algebra
{
    ...
    public abstract class SparseSolver<T> : SparseLinearSystem<T> where T : IFormattable, IEquatable<T>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SparseSolver{T}"/> class.
        /// </summary>
        /// <param name="strategy">The pivot strategy that needs to be used.</param>
        protected SparseSolver(PivotStrategy<T> strategy)
        {
        ...
        protected SparseSolver(PivotStrategy<T> strategy, int size)
            : base(size)
        {
            NeedsReordering = true;
            Strategy = strategy.ThrowIfNull(nameof(strategy));
